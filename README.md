# Jupyter Notebook Scientific Python Stack + Agave Tooling  
...
Standard Docker build semantics apply.

```
docker build -t agaveplatform/jupyter-datascience-notebook .
```  
...
c.DockerSpawner.container_image = 'agaveplatform/jupyter-datascience-notebook'
...
```
docker run -it --rm agaveplatform/jupyter-datascience-notebook start.sh ipython
```
